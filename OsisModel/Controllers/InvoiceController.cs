...
namespace okisSIS.Controllers
{
    public class InvoiceController : Controller
    {
        ...
        public ActionResult Create(InvoiceViewModel invoiceVM)
        {
        ...
        /*
                public ActionResult Report( String id)
                {
                    ...
                    feereport.Load(Server.MapPath("~/Reports/FeeReceipt.rpt"));
                ...
                public ActionResult Create(String id)
                {
                    ...
                    { 
                        ...
                        model.InvoiceDetail = invdetail;
                        ViewBag.StudentName = "Create fee receipt for " +  student.NameOfChild;
